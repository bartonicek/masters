...
plot1.handlers.draghandler1 = new hndl.RectDragHandler().registerCallback(plot1.drawUser);
plot1.scales.x = new scls.XYScaleContinuous(plot1.width);
plot1.scales.y = new scls.XYScaleContinuous(plot1.height, -1);
plot1.representations.points1 = new reps.Points(plot1.wranglers.identity1, plot1.handlers.draghandler1);
plot1.auxiliaries.axisbox1 = new auxs.AxisBox();
plot1.auxiliaries.rectdragbox1 = new auxs.RectDragBox(plot1.handlers.draghandler1);
plot1.initialize();
...
plot2.wranglers.summary1 = new Wrangler(data1, mapping2)
    ...
    .splitWhat("y")
    .doWithin(funs.mean);
plot2.handlers.draghandler1 = new hndl.RectDragHandler().registerCallback(plot2.drawUser);
...
plot2.auxiliaries.rectdragbox1 = new auxs.RectDragBox(plot2.handlers.draghandler1);
plot2.initialize();
