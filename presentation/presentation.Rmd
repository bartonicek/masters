...
- <b> Built for static viz first, interactive second </b>
  - Difficult to achieve "interesting" interactivity (e.g. linking multiple plots) 
...
- <b>Project</b>: Lay foundations for a general-purpose interactive viz library/package, designed with interactivity-first & principled data viz mindset
- <b>Back-end written in TypeScript</b> (a fancier version of JavaScript)
